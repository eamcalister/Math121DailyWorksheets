...
},
{
  ...
  "body": " Monday Week 1 - Review of Functions with Algebra     Review functions, function notation, and inputs\/outputs using algebra.  Review the domain and range of a function.     Today we will review inputs and outputs of functions.     A function is ...    The most fundamental tasks with functions are to evaluate them at an input (to obtain the output) and solve for the input given the output.    Let . Find and solve the equation .       Evaluate and Solve Exercises    Let . Evaluate and solve the equation .    Let . Evaluate and solve the equation .         The domain of a function is..  The range of a function is..    To find the domain and\/or range of a function, ome useful strategies are...    Find the domain and range of .         Exercises Finding the Domain  Find the domain of each of the following functions.                          "
},
{
  "id": "objectives",
  "level": "2",
